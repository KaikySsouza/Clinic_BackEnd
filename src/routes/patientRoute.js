...
import { PatientSchema, ViewPatientAllSchema, ViewPatientSchema } from "../schemas/patient.schema.js";
...
PacientRoute.get('/patients/list',   validate(ViewPatientAllSchema), PacientListAll);
